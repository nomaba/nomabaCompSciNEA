...
namespace ArduinoFormsTest
{
    public partial class ArduinoControls : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e) // This will run when the program is started
        {
            comboBoxPorts.Items.AddRange(SerialPort.GetPortNames());
        }
        private void Form1_FormClosing(object sender, FormClosingEventArgs e) // This will run when the program is closed
        {
        ...
        private void buttonConnect_Click(object sender, EventArgs e) // This will run when the connect button is pressed
        {
        ...
        private void buttonQuit_Click(object sender, EventArgs e) // This will run when the program is closed using the Quit button
        {
            if (serialPort.IsOpen)
            {
                serialPort.Close();
        ...
        private void lightOn_Click(object sender, EventArgs e) // This will run when the light on button is pressed
        {
            if (serialPort.IsOpen)
            {
        ...
        private void lightOff_Click(object sender, EventArgs e) // This will run when the light off button is pressed
        {
            if (serialPort.IsOpen)
            {
